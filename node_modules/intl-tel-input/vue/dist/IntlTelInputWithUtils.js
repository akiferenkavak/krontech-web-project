import { n as e, t } from "./IntlTelInput-DWpqqgvZ.js";
//#region dist/js/utils.js
var n = {};
//#endregion
//#region vue/src/indexWithUtils.ts
(function() {
	var e = this || self;
	function t(t, n) {
		t = t.split(".");
		var r = e;
		t[0] in r || r.execScript === void 0 || r.execScript("var " + t[0]);
		for (var i; t.length && (i = t.shift());) t.length || n === void 0 ? r = r[i] && r[i] !== Object.prototype[i] ? r[i] : r[i] = {} : r[i] = n;
	}
	function n(e, t) {
		function n() {}
		n.prototype = t.prototype, e.na = t.prototype, e.prototype = new n(), e.prototype.constructor = e, e.ta = function(e, n, r) {
	...
	class te {
		constructor() {
			...
			if (ee !== ee) throw Error("SafeHtml is not meant to be built directly");
			this.g = t;
		}
		toString() {
			return this.g.toString();
	...
	new te();
	function ne(e, t) {
		switch (this.g = e, this.l = !!t.ca, this.h = t.i, this.u = t.type, this.o = !1, this.h) {
			case ae:
			case oe:
			case se:
			case ce:
	...
	var re = 1, ie = 2, ae = 3, oe = 4, se = 6, ce = 16, le = 18;
	function ue(e, t) {
		for (this.h = e, this.g = {}, e = 0; e < t.length; e++) {
			var n = t[e];
			this.g[n.g] = n;
		}
	}
	function de(e) {
		return e = r(e.g), e.sort(function(e, t) {
			return e.g - t.g;
		}), e;
	}
	function u() {
	...
	u.prototype.has = function(e) {
		...
		for (var t = de(this.m()), n = 0; n < t.length; n++) {
			var r = t[n], i = r.g;
			if (d(this, i) != d(e, i)) return !1;
			if (d(this, i)) {
				var a = r.h == 11 || r.h == 10, o = f(this, i);
				if (i = f(e, i), r.l) {
					if (o.length != i.length) return !1;
					for (r = 0; r < o.length; r++) {
						var s = o[r], c = i[r];
						if (a ? !s.equals(c) : s != c) return !1;
					}
				} else if (a ? !o.equals(i) : o != i) return !1;
			}
		}
		return !0;
	};
	function fe(e, t) {
		for (var n = de(e.m()), r = 0; r < n.length; r++) {
			var i = n[r], a = i.g;
			if (d(t, a)) {
				e.g && delete e.g[i.g];
				var o = i.h == 11 || i.h == 10;
				if (i.l) {
					i = f(t, a) || [];
					for (var s = 0; s < i.length; s++) _(e, a, o ? i[s].clone() : i[s]);
				} else i = f(t, a), o ? (o = f(e, a)) ? fe(o, i) : g(e, a, i.clone()) : g(e, a, i);
			}
		}
	}
	u.prototype.clone = function() {
		var e = new this.constructor();
		return e != this && (e.h = {}, e.g &&= {}, fe(e, this)), e;
	};
	function d(e, t) {
		return e.h[t] != null;
	}
	function f(e, t) {
		...
		if (e.l) {
			if (!(t in e.g)) {
				var r = e.l, i = e.j[t];
				if (n != null) if (i.l) {
					for (var a = [], o = 0; o < n.length; o++) a[o] = r.h(i, n[o]);
					n = a;
				} else n = r.h(i, n);
				return e.g[t] = n;
			}
	...
	function p(e, t, n) {
		var r = f(e, t);
		return e.j[t].l ? r[n || 0] : r;
	}
	function m(e, t) {
		if (d(e, t)) e = p(e, t);
		else a: {
			if (e = e.j[t], e.j === void 0) if (t = e.u, t === Boolean) e.j = !1;
			else if (t === Number) e.j = 0;
			else if (t === String) e.j = e.o ? "0" : "";
			else {
				e = new t();
				break a;
			}
	...
	function h(e, t) {
		return e.j[t].l ? d(e, t) ? e.h[t].length : 0 : +!!d(e, t);
	}
	function g(e, t, n) {
		e.h[t] = n, e.g && (e.g[t] = n);
	}
	function _(e, t, n) {
		e.h[t] || (e.h[t] = []), e.h[t].push(n), e.g && delete e.g[t];
	}
	function v(e, t) {
		var n = [], r;
		for (r in t) r != 0 && n.push(new ne(r, t[r]));
		return new ue(e, n);
	}
	function y() {}
	y.prototype.g = function(e) {
		throw new e.h(), Error("Unimplemented");
	}, y.prototype.h = function(e, t) {
		if (e.h == 11 || e.h == 10) return t instanceof u ? t : this.g(e.u.prototype.m(), t);
		if (e.h == 14) return typeof t == "string" && pe.test(t) && (e = Number(t), e > 0) ? e : t;
		if (!e.o) return t;
		if (e = e.u, e === String) {
			if (typeof t == "number") return String(t);
		} else if (e === Number && typeof t == "string" && (t === "Infinity" || t === "-Infinity" || t === "NaN" || pe.test(t))) return Number(t);
		return t;
	};
	var pe = /^-?[0-9]+$/;
	function b() {}
	n(b, y), b.prototype.g = function(e, t) {
		return e = new e.h(), e.l = this, e.h = t, e.g = {}, e;
	};
	function x() {}
	n(x, b), x.prototype.h = function(e, t) {
		return e.h == 8 ? !!t : y.prototype.h.apply(this, arguments);
	}, x.prototype.g = function(e, t) {
		return x.na.g.call(this, e, t);
	};
	function S(e, t) {
		e != null && this.g.apply(this, arguments);
	}
	S.prototype.h = "", S.prototype.set = function(e) {
		this.h = "" + e;
	}, S.prototype.g = function(e, t, n) {
		if (this.h += String(e), t != null) for (let e = 1; e < arguments.length; e++) this.h += arguments[e];
		return this;
	};
	function C(e) {
		e.h = "";
	...
	}, w.m = w.prototype.m, T.prototype.m = function() {
		var e = he;
		return e || (he = e = v(T, {
			0: {
	...
	}, T.m = T.prototype.m, D.prototype.m = function() {
		var e = ge;
		return e || (ge = e = v(D, {
			0: {
				name: "PhoneMetadata",
	...
	A.h = void 0, A.g = function() {
		return A.h ? A.h : A.h = new A();
	};
	var j = {
		0: "0",
		1: "1",
		...
		Y: "9",
		Z: "9"
	}, Se = RegExp("[+＋]+"), M = RegExp("^[+＋]+"), N = RegExp("([0-9０-９٠-٩۰-۹])"), Ce = RegExp("[+＋0-9０-９٠-٩۰-۹]"), we = /[\\\/] *x/, Te = RegExp("[^0-9０-９٠-٩۰-۹A-Za-z#]+$"), Ee = /(?:.*?[A-Za-z]){3}.*/, De = RegExp("^\\+([0-9０-９٠-٩۰-۹]|[\\-\\.\\(\\)]?)*[0-9０-９٠-٩۰-۹]([0-9０-９٠-٩۰-۹]|[\\-\\.\\(\\)]?)*$"), Oe = RegExp("^([A-Za-z0-9０-９٠-٩۰-۹]+((\\-)*[A-Za-z0-9０-９٠-٩۰-۹])*\\.)*[A-Za-z]+((\\-)*[A-Za-z0-9０-９٠-٩۰-۹])*\\.?$");
	function P(e) {
		return "([0-9０-９٠-٩۰-۹]{1," + e + "})";
	}
	function F() {
		return ";ext=" + P("20") + "|[ \xA0\\t,]*(?:e?xt(?:ensi(?:ó?|ó))?n?|ｅ?ｘｔｎ?|доб|anexo)[:\\.．]?[ \xA0\\t,-]*" + (P("20") + "#?|[ \xA0\\t,]*(?:[xｘ#＃~～]|int|ｉｎｔ)[:\\.．]?[ \xA0\\t,-]*") + (P("9") + "#?|[- ]+") + (P("6") + "#|[ \xA0\\t]*(?:,{2}|;)[:\\.．]?[ \xA0\\t,-]*") + (P("15") + "#?|[ \xA0\\t]*(?:,)+[:\\.．]?[ \xA0\\t,-]*") + (P("9") + "#?");
	}
	var I = RegExp("(?:" + F() + ")$", "i"), ke = RegExp("^[0-9０-９٠-٩۰-۹]{2}$|^[+＋]*(?:[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～*]*[0-9０-９٠-٩۰-۹]){3,}[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～*A-Za-z0-9０-９٠-٩۰-۹]*(?:" + F() + ")?$", "i"), Ae = /(\$\d)/, je = /^\(?\$1\)?$/;
	function Me(e) {
		return e.length < 2 ? !1 : Y(ke, e);
	}
	function Ne(e) {
		return Y(Ee, e) ? L(e, xe) : L(e, j);
	}
	function Pe(e) {
		var t = Ne(e.toString());
		C(e), e.g(t);
	...
	function Fe(e) {
		return e != null && (h(e, 9) != 1 || E(e)[0] != -1);
	}
	function L(e, t) {
		for (var n = new S(), r, i = e.length, a = 0; a < i; ++a) r = e.charAt(a), r = t[r.toUpperCase()], r != null && n.g(r);
		return n.toString();
	}
	function Ie(e) {
		return e.length == 0 || je.test(e);
	}
	function R(e) {
		return e != null && isNaN(e) && e.toUpperCase() in ye;
	}
	A.prototype.format = function(e, t) {
		...
		n = m(e, 1);
		var r = B(e);
		if (t == 0) return Le(n, 0, r, "");
		if (!(n in k)) return r;
		var i = z(this, n, G(n));
		e = d(e, 3) && p(e, 3).length != 0 ? t == 3 ? ";ext=" + p(e, 3) : d(i, 13) ? p(i, 13) + m(e, 3) : " ext. " + m(e, 3) : "";
		a: {
			i = (f(i, 20) || []).length == 0 || t == 2 ? f(i, 19) || [] : f(i, 20) || [];
			for (var a, o = i.length, s = 0; s < o; ++s) {
				a = i[s];
				var c = h(a, 3);
				if ((c == 0 || r.search(p(a, 3, c - 1)) == 0) && (c = new RegExp(p(a, 1)), Y(c, r))) {
					i = a;
					break a;
				}
			}
		...
		return i != null && (o = i, i = m(o, 2), a = new RegExp(p(o, 1)), m(o, 5), o = m(o, 4), r = t == 2 && o != null && o.length > 0 ? r.replace(a, i.replace(Ae, o)) : r.replace(a, i), t == 3 && (r = r.replace(RegExp("^[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]+"), ""), r = r.replace(RegExp("[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]+", "g"), "-"))), Le(n, t, r, e);
	};
	function z(e, t, n) {
		return n == "001" ? U(e, "" + t) : U(e, n);
	}
	function B(e) {
		if (!d(e, 2)) return "";
		var t = "" + p(e, 2);
		return d(e, 4) && p(e, 4) && m(e, 8) > 0 ? Array(m(e, 8) + 1).join("0") + t : t;
	}
	function Le(e, t, n, r) {
		switch (t) {
			case 0: return "+" + e + n + r;
			case 1: return "+" + e + " " + n + r;
			case 3: return "tel:+" + e + "-" + n + r;
			default: return n + r;
		}
	}
	function V(e, t) {
		switch (t) {
			...
			case 6: return p(e, 8);
			case 7: return p(e, 7);
			case 8: return p(e, 21);
			case 9: return p(e, 25);
			case 10: return p(e, 28);
			default: return p(e, 1);
		}
	}
	function Re(e, t) {
		var n = Be(e, t);
		return e = z(e, m(t, 1), n), e == null ? -1 : (t = B(t), H(t, e));
	}
	function H(e, t) {
		return W(e, p(t, 1)) ? W(e, p(t, 5)) ? 4 : W(e, p(t, 4)) ? 3 : W(e, p(t, 6)) ? 5 : W(e, p(t, 8)) ? 6 : W(e, p(t, 7)) ? 7 : W(e, p(t, 21)) ? 8 : W(e, p(t, 25)) ? 9 : W(e, p(t, 28)) ? 10 : W(e, p(t, 2)) ? p(t, 18) || W(e, p(t, 3)) ? 2 : 0 : !p(t, 18) && W(e, p(t, 3)) ? 1 : -1 : -1;
	}
	function U(e, t) {
		...
		var n = e.g[t];
		if (n == null) {
			if (n = ye[t], n == null) return null;
			n = new x().g(D.m(), n), e.g[t] = n;
		}
		return n;
	}
	function W(e, t) {
		var n = e.length;
		return h(t, 9) > 0 && E(t).indexOf(n) == -1 ? !1 : Y(m(t, 2), e);
	}
	function ze(e, t) {
		var n = Be(e, t), r = m(t, 1), i = z(e, r, n);
		return i == null || n != "001" && r != Ve(e, n) ? i = !1 : (e = B(t), i = H(e, i) != -1), i;
	}
	function Be(e, t) {
		if (t == null) return null;
		var n = m(t, 1);
		if (n = k[n], n == null) e = null;
		else if (n.length == 1) e = n[0];
		else a: {
			t = B(t);
	...
	function G(e) {
		return e = k[e], e == null ? "ZZ" : e[0];
	}
	function Ve(e, t) {
		if (e = U(e, t), e == null) throw Error("Invalid region code: " + t);
		return m(e, 10);
	}
	function K(e, t, n, r) {
		var i = V(n, r), a = h(i, 9) == 0 ? E(p(n, 1)) : E(i);
		if (i = f(i, 10) || [], r == 2) if (Fe(V(n, 0))) e = V(n, 1), Fe(e) && (a = a.concat(h(e, 9) == 0 ? E(p(n, 1)) : E(e)), a.sort(), i.length == 0 ? i = f(e, 10) || [] : (i = i.concat(f(e, 10) || []), i.sort()));
		else return K(e, t, n, 1);
		return a[0] == -1 ? 5 : (t = t.length, i.indexOf(t) > -1 ? 4 : (n = a[0], n == t ? 0 : n > t ? 2 : a[a.length - 1] < t ? 3 : a.indexOf(t, 1) > -1 ? 0 : 5));
	}
	function q(e, t, n) {
		var r = B(t);
		return t = m(t, 1), t in k ? (t = z(e, t, G(t)), K(e, r, t, n)) : 1;
	}
	function He(e, t) {
		if (e = e.toString(), e.length == 0 || e.charAt(0) == "0") return 0;
		for (var n, r = e.length, i = 1; i <= 3 && i <= r; ++i) if (n = parseInt(e.substring(0, i), 10), n in k) return t.g(e.substring(i)), n;
		return 0;
	}
	function Ue(e, t, n, r, i, a) {
		...
		t = new S(t);
		var o;
		n != null && (o = p(n, 11)), o ??= "NonMatch";
		var s = t.toString();
		if (s.length == 0) o = 20;
		else if (M.test(s)) s = s.replace(M, ""), C(t), t.g(Ne(s)), o = 1;
		else {
			if (s = new RegExp(o), Pe(t), o = t.toString(), o.search(s) == 0) {
				s = o.match(s)[0].length;
				var c = o.substring(s).match(N);
				c && c[1] != null && c[1].length > 0 && L(c[1], j) == "0" ? o = !1 : (C(t), t.g(o.substring(s)), o = !0);
			} else o = !1;
			o = o ? 5 : 20;
		}
		if (i && g(a, 6, o), o != 20) {
			if (t.h.length <= 2) throw Error("Phone number too short after IDD");
			if (e = He(t, r), e != 0) return g(a, 1, e), e;
			throw Error("Invalid country calling code");
		}
		return n != null && (o = m(n, 10), s = "" + o, c = t.toString(), c.lastIndexOf(s, 0) == 0 && (s = new S(c.substring(s.length)), c = p(n, 1), c = new RegExp(m(c, 2)), We(s, n, null), s = s.toString(), !Y(c, t.toString()) && Y(c, s) || K(e, t.toString(), n, -1) == 3)) ? (r.g(s), i && g(a, 6, 10), g(a, 1, o), o) : (g(a, 1, 0), 0);
	}
	function We(e, t, n) {
		var r = e.toString(), i = r.length, a = p(t, 15);
		if (i != 0 && a != null && a.length != 0 && (a = RegExp("^(?:" + a + ")"), i = a.exec(r))) {
			var o = RegExp, s = p(t, 1);
			s = m(s, 2), o = new o(s), s = Y(o, r);
			var c = i.length - 1;
			t = p(t, 16), t == null || t.length == 0 || i[c] == null || i[c].length == 0 ? (!s || Y(o, r.substring(i[0].length))) && (n != null && c > 0 && i[c] != null && n.g(i[1]), e.set(r.substring(i[0].length))) : (r = r.replace(a, t), (!s || Y(o, r)) && (n != null && c > 0 && n.g(i[1]), e.set(r)));
		}
	}
	function J(e, t, n) {
		if (!R(n) && t.length > 0 && t.charAt(0) != "+") throw Error("Invalid country calling code");
		return Ge(e, t, n, !0);
	}
	function Ge(e, t, n, r) {
		if (t == null) throw Error("The string supplied did not seem to be a phone number");
		if (t.length > 250) throw Error("The string supplied is too long to be a phone number");
		var i = new S(), a = t.indexOf(";phone-context=");
		if (a === -1) a = null;
		else if (a += 15, a >= t.length) a = "";
		else {
			var o = t.indexOf(";", a);
			a = o === -1 ? t.substring(a) : t.substring(a, o);
		}
		var s = a;
		if (s == null ? o = !0 : s.length === 0 ? o = !1 : (o = De.exec(s), s = Oe.exec(s), o = o !== null || s !== null), !o || (a == null ? (a = i.g, o = t ?? "", s = o.search(Ce), s >= 0 ? (o = o.substring(s), o = o.replace(Te, ""), s = o.search(we), s >= 0 && (o = o.substring(0, s))) : o = "", a.call(i, o)) : (a.charAt(0) === "+" && i.g(a), a = t.indexOf("tel:"), i.g(t.substring(a >= 0 ? a + 4 : 0, t.indexOf(";phone-context=")))), a = i.toString(), o = a.indexOf(";isub="), o > 0 && (C(i), i.g(a.substring(0, o))), !Me(i.toString()))) throw Error("The string supplied did not seem to be a phone number");
		if (a = i.toString(), !(R(n) || a != null && a.length > 0 && M.test(a))) throw Error("Invalid country calling code");
		a = new O(), r && g(a, 5, t);
		a: {
			if (t = i.toString(), o = t.search(I), o >= 0 && Me(t.substring(0, o))) {
				s = t.match(I);
				for (var c = s.length, l = 1; l < c; ++l) if (s[l] != null && s[l].length > 0) {
					C(i), i.g(t.substring(0, o)), t = s[l];
					break a;
				}
			}
			t = "";
		}
		t.length > 0 && g(a, 3, t), o = U(e, n), t = new S(), s = 0, c = i.toString();
		try {
			s = Ue(e, c, o, t, r, a);
		} catch (n) {
			if (n.message == "Invalid country calling code" && M.test(c)) {
				if (c = c.replace(M, ""), s = Ue(e, c, o, t, r, a), s == 0) throw n;
			} else throw n;
		}
		if (s == 0 ? (Pe(i), t.g(i.toString()), n == null ? r && (delete a.h[6], a.g && delete a.g[6]) : (s = m(o, 10), g(a, 1, s))) : (i = G(s), i != n && (o = z(e, s, i))), t.h.length < 2 || (o != null && (n = new S(), i = new S(t.toString()), We(i, o, n), e = K(e, i.toString(), o, -1), e != 2 && e != 4 && e != 5 && (t = i, r && n.toString().length > 0 && g(a, 7, n.toString()))), r = t.toString(), e = r.length, e < 2)) throw Error("The string supplied is too short to be a phone number");
		if (e > 17) throw Error("The string supplied is too long to be a phone number");
		if (r.length > 1 && r.charAt(0) == "0") {
			for (g(a, 4, !0), e = 1; e < r.length - 1 && r.charAt(e) == "0";) e++;
			e != 1 && g(a, 8, e);
		}
		return g(a, 2, parseInt(r, 10)), a;
	}
	function Y(e, t) {
		return !!((e = t.match(RegExp("^(?:" + (typeof e == "string" ? e : e.source) + ")$", "i"))) && e[0].length == t.length);
	}
	function Ke(e) {
		this.ga = RegExp(" "), this.ka = "", this.$ = new S(), this.ea = "", this.u = new S(), this.da = new S(), this.v = !0, this.fa = this.aa = this.ma = !1, this.ha = A.g(), this.ba = 0, this.h = new S(), this.ia = !1, this.o = "", this.g = new S(), this.j = [], this.la = e, this.l = Xe(this, this.la);
	}
	var qe = new D();
	g(qe, 11, "NA");
	var Je = RegExp("^[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*\\$1[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*(\\$\\d[-x‐-―−ー－-／ \xA0­​⁠　()（）［］.\\[\\]/~⁓∼～]*)*$"), Ye = /[- ]/;
	function Xe(e, t) {
		var n = e.ha;
		return t = R(t) ? Ve(n, t) : 0, e = U(e.ha, G(t)), e ?? qe;
	}
	function Ze(e) {
		for (var t = e.j.length, n = 0; n < t; ++n) {
			...
			var c = a;
			o = m(o, 2);
			var l = "999999999999999".match(s)[0];
			if (l.length < c.g.h.length ? c = "" : (c = l.replace(new RegExp(s, "g"), o), c = c.replace(RegExp("9", "g"), " ")), c.length > 0 ? (a.$.g(c), a = !0) : a = !1, a) return e.ea = i, e.ia = Ye.test(p(r, 4)), e.ba = 0, !0;
		}
		return e.v = !1;
	}
	function X(e, t) {
		for (var n = [], r = t.length - 3, i = e.j.length, a = 0; a < i; ++a) {
			var o = e.j[a];
			h(o, 3) == 0 ? n.push(e.j[a]) : (o = p(o, 3, Math.min(r, h(o, 3) - 1)), t.search(o) == 0 && n.push(e.j[a]));
		}
		e.j = n;
	}
	function Qe(e, t) {
		e.u.g(t);
		var n = t;
		if (N.test(n) || e.u.h.length == 1 && Se.test(n) ? (t == "+" ? (n = t, e.da.g(t)) : (n = j[t], e.da.g(n), e.g.g(n)), t = n) : (e.v = !1, e.ma = !0), !e.v) {
			if (!e.ma) {
				if (rt(e)) {
					if (it(e)) return $e(e);
				} else if (e.o.length > 0 && (t = e.g.toString(), C(e.g), e.g.g(e.o), e.g.g(t), t = e.h.toString(), n = t.lastIndexOf(e.o), C(e.h), e.h.g(t.substring(0, n))), e.o != nt(e)) return e.h.g(" "), $e(e);
			}
			return e.u.toString();
		}
		switch (e.da.h.length) {
			case 0:
			case 1:
			case 2: return e.u.toString();
			case 3: if (rt(e)) e.fa = !0;
			else return e.o = nt(e), Q(e);
			default: return e.fa ? (it(e) && (e.fa = !1), e.h.toString() + e.g.toString()) : e.j.length > 0 ? (t = at(e, t), n = et(e), n.length > 0 ? n : (X(e, e.g.toString()), Ze(e) ? tt(e) : e.v ? Z(e, t) : e.u.toString())) : Q(e);
		}
	}
	function $e(e) {
		return e.v = !0, e.fa = !1, e.j = [], e.ba = 0, C(e.$), e.ea = "", Q(e);
	}
	function et(e) {
		for (var t = e.g.toString(), n = e.j.length, r = 0; r < n; ++r) {
			var i = e.j[r], a = m(i, 1);
			if (RegExp("^(?:" + a + ")$").test(t) && (e.ia = Ye.test(p(i, 4)), i = t.replace(new RegExp(a, "g"), p(i, 2)), i = Z(e, i), L(i, be) == e.da)) return i;
		}
		return "";
	}
	function Z(e, t) {
		var n = e.h.h.length;
		return e.ia && n > 0 && e.h.toString().charAt(n - 1) != " " ? e.h + " " + t : e.h + t;
	}
	function Q(e) {
		var t = e.g.toString();
		if (t.length >= 3) {
			for (var n = e.aa && e.o.length == 0 && h(e.l, 20) > 0 ? f(e.l, 20) || [] : f(e.l, 19) || [], r = n.length, i = 0; i < r; ++i) {
				var a = n[i];
				e.o.length > 0 && Ie(m(a, 4)) && !p(a, 6) && !d(a, 5) || (e.o.length != 0 || e.aa || Ie(m(a, 4)) || p(a, 6)) && Je.test(m(a, 2)) && e.j.push(a);
			}
			return X(e, t), t = et(e), t.length > 0 ? t : Ze(e) ? tt(e) : e.u.toString();
		}
		return Z(e, t);
	}
	function tt(e) {
		var t = e.g.toString(), n = t.length;
		if (n > 0) {
			for (var r = "", i = 0; i < n; i++) r = at(e, t.charAt(i));
			return e.v ? Z(e, r) : e.u.toString();
		}
		return e.h.toString();
	}
	function nt(e) {
		var t = e.g.toString(), n = 0;
		if (p(e.l, 10) != 1) var r = !1;
		else r = e.g.toString(), r = r.charAt(0) == "1" && r.charAt(1) != "0" && r.charAt(1) != "1";
		return r ? (n = 1, e.h.g("1").g(" "), e.aa = !0) : d(e.l, 15) && (r = RegExp("^(?:" + p(e.l, 15) + ")"), r = t.match(r), r != null && r[0] != null && r[0].length > 0 && (e.aa = !0, n = r[0].length, e.h.g(t.substring(0, n)))), C(e.g), e.g.g(t.substring(n)), t.substring(0, n);
	}
	function rt(e) {
		var t = e.da.toString(), n = RegExp("^(?:\\+|" + p(e.l, 11) + ")");
		return n = t.match(n), n != null && n[0] != null && n[0].length > 0 ? (e.aa = !0, n = n[0].length, C(e.g), e.g.g(t.substring(n)), C(e.h), e.h.g(t.substring(0, n)), t.charAt(0) != "+" && e.h.g(" "), !0) : !1;
	}
	function it(e) {
		if (e.g.h.length == 0) return !1;
		var t = new S(), n = He(e.g, t);
		return n == 0 ? !1 : (C(e.g), e.g.g(t.toString()), t = G(n), t == "001" ? e.l = U(e.ha, "" + n) : t != e.la && (e.l = Xe(e, t)), e.h.g("" + n).g(" "), e.o = "", !0);
	}
	function at(e, t) {
		var n = e.$.toString();
		if (n.substring(e.ba).search(e.ga) >= 0) {
			var r = n.search(e.ga);
			return t = n.replace(e.ga, t), C(e.$), e.$.g(t), e.ba = r, t.substring(0, e.ba + 1);
		}
		return e.j.length == 1 && (e.v = !1), e.ea = "", e.u.toString();
	}
	let ot = (e) => {
		let t = [];
		return e.includes("FIXED_LINE_OR_MOBILE") ? (e.includes("MOBILE") || t.push("MOBILE"), e.includes("FIXED_LINE") || t.push("FIXED_LINE")) : (e.includes("MOBILE") || e.includes("FIXED_LINE")) && t.push("FIXED_LINE_OR_MOBILE"), e.concat(t);
	}, $ = {
		FIXED_LINE: 0,
		MOBILE: 1,
	...
	t("utils", {}), t("utils.formatNumberAsYouType", (e, t) => {
		try {
			let n = e.replace(/[^+0-9]/g, ""), r = new Ke(t);
			t = "";
			for (let e = 0; e < n.length; e++) r.ka = Qe(r, n.charAt(e)), t = r.ka;
			return t;
		} catch {
			return e;
		}
	}), t("utils.formatNumber", (e, t, n) => {
		try {
			let i = A.g(), a = J(i, e, t);
			var r = q(i, a, -1);
			return r == 0 || r == 4 ? i.format(a, n === void 0 ? 0 : n) : e;
		} catch {
			return e;
		}
	}), t("utils.getExampleNumber", (e, t, n, r) => {
		try {
			let s = A.g();
			a: {
				var i = s;
			...
			return s.format(o, r ? 0 : t ? 2 : 1);
		} catch {
			return "";
		}
	}), t("utils.getExtension", (e, t) => {
		try {
			return p(J(A.g(), e, t), 3);
		} catch {
			return "";
		}
	}), t("utils.getNumberType", (e, t) => {
		try {
			let n = A.g();
			return Re(n, J(n, e, t));
		} catch {
	...
	}), t("utils.getValidationError", (e, t) => {
		if (!t) return 1;
		try {
			let n = A.g();
			return q(n, J(n, e, t), -1);
		} catch (t) {
			return t.message === "Invalid country calling code" ? 1 : e.length <= 3 || t.message === "Phone number too short after IDD" || t.message === "The string supplied is too short to be a phone number" ? 2 : t.message === "The string supplied is too long to be a phone number" ? 3 : -99;
		}
	}), t("utils.isValidNumber", (e, t, n) => {
		try {
			let r = A.g(), i = J(r, e, t), a = ze(r, i);
			if (n) {
				let e = ot(n).map((e) => $[e]);
				return a && e.includes(Re(r, i));
			}
			return a;
		} catch {
			return !1;
		}
	}), t("utils.isPossibleNumber", (e, t, n) => {
		try {
			let r = A.g(), i = J(r, e, t);
			if (n) {
				let e = ot(n);
				for (let t of e) if (q(r, i, $[t]) === 0) return !0;
				return !1;
			}
			return q(r, i, -1) === 0;
		} catch {
	...
	}), t("utils.getCoreNumber", (e, t) => {
		try {
			return p(J(A.g(), e, t), 2).toString();
		} catch {
			return "";
		}
	}), t("utils.numberFormat", {
		E164: 0,
		INTERNATIONAL: 1,
		NATIONAL: 2,
		RFC3966: 3
	}), t("utils.numberType", $), t("utils.validationError", {
		IS_POSSIBLE: 0,
...
}).call(n), e.utils = n.utils;
//#endregion
export { t as default, e as intlTelInput };
